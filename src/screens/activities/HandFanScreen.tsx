    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          Build a hand fan from paper or cardboard and measure its cooling effectiveness by
          tracking air movement with the phone's accelerometer. Teams compare different fan
          designs to determine which produces maximum airflow.
        </Text>
        <Text style={styles.body}>
          Investigate the relationship between fan size, fold density, and waving frequency.
          Teams record time-to-cool readings and submit their best score to the leaderboard.
        </Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionHeading}>Equipment needed</Text>
        {['Paper or lightweight cardboard', 'Ruler and scissors', 'Tape or glue', 'Thermometer or temperature sensor', 'Timer'].map((item) => (
