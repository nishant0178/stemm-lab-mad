    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          Design and build a parachute to carry a small payload safely to the ground. Teams
          measure landing forces using the phone's accelerometer and calculate deceleration
          rates across different parachute materials and designs.
        </Text>
        <Text style={styles.body}>
          Compare canopy size, shape, and vent hole diameter to determine which configuration
          produces the gentlest landing. Data is logged and compared across teams on the
          leaderboard.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        {['Plastic bag or lightweight fabric', 'String or thread (1 m)', 'Tape and scissors', 'Small weight or boiled egg', 'Phone with accelerometer'].map((item) => (
