    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          Use the phone's microphone to measure ambient sound levels across different locations
          in and around the school. Teams identify sources of noise pollution and record decibel
          readings at regular intervals.
        </Text>
        <Text style={styles.body}>
          Map noise hotspots, compare indoor versus outdoor readings, and investigate how
          sound levels vary by time of day. Results are submitted to the leaderboard for
          cross-team analysis.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        {['Phone with microphone', 'Measuring tape', 'Data recording sheet', 'Hearing protection (optional)', 'Map of school grounds'].map((item) => (
