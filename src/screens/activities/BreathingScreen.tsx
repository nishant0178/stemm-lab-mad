...
export default function BreathingScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Breathing Pace</Text>
      <Text style={styles.subtitle}>From the STEMM Lab specification</Text>

      <View style={styles.section}>
        <Text style={styles.sectionHeading}>Overview</Text>
        <Text style={styles.body}>
          Measure and analyse breathing rate at rest and after varying levels of physical
          activity. Teams count breaths per minute at baseline, after light activity, and after
          vigorous exercise to build a breathing response profile.
        </Text>
        <Text style={styles.body}>
          Investigate how factors such as age, fitness level, and posture influence breathing
          pace. Compare results across team members and correlate with heart rate data from
          the Human Performance activity.
        </Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionHeading}>Equipment needed</Text>
        {['Timer or stopwatch', 'Data recording sheet', 'Comfortable seating area', 'Space for light and vigorous exercise', 'Calculator for averages'].map((item) => (
